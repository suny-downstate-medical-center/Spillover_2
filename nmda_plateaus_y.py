...
with open(iMSN_library, 'rb') as f:
    model_sets  = pickle.load(f, encoding="latin1")
# morphology = "../all_morphologies/luebke/CNG version/Apr13IR3b.CNG.swc"
# morphology = "./morphology/WT-dMSN_P270-20_1.02_SGA1-m24.swc"
morphology = "../all_morphologies/almuhtasib/CNG version/29_10.CNG.swc"
...
cell = msn.MSN(morphology=morphology, variables = variables) 
