...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_pf_NMDA /mnt/data/Spillover_2/mod/adaptive_pf_NMDA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/data/Spillover_2/mod/adaptive_pf_NMDA.mod";
static const char* nmodl_file_text = 
  "\n"
  "\n"
