...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 adaptive_glutamate_cshom /www/projects/Spillover/mod/adaptive_glutamate_cshom.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/www/projects/Spillover/mod/adaptive_glutamate_cshom.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
