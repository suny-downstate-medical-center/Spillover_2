...
#define nrn_init _nrn_init__adaptive_glutamate_shom
#define _nrn_initial _nrn_initial__adaptive_glutamate_shom
#define nrn_cur _nrn_cur__adaptive_glutamate_shom
#define _nrn_current _nrn_current__adaptive_glutamate_shom
#define nrn_jacob _nrn_jacob__adaptive_glutamate_shom
#define nrn_state _nrn_state__adaptive_glutamate_shom
#define _net_receive _net_receive__adaptive_glutamate_shom 
#define state state__adaptive_glutamate_shom 
...
#define delta _p[18]
#define delta_columnindex 18
#define hthresh_LTP_const _p[19]
#define hthresh_LTP_const_columnindex 19
#define learning_rate_thresh_LTP _p[20]
#define learning_rate_thresh_LTP_columnindex 20
#define learning_rate_thresh_LTD _p[21]
#define learning_rate_thresh_LTD_columnindex 21
#define n _p[22]
#define n_columnindex 22
#define ca_nmdai_max _p[23]
#define ca_nmdai_max_columnindex 23
#define cali_max _p[24]
#define cali_max_columnindex 24
#define active_syn_flag _p[25]
#define active_syn_flag_columnindex 25
...
#define i_ampa _p[29]
#define i_ampa_columnindex 29
#define i_nmda _p[30]
#define i_nmda_columnindex 30
#define g_ampa _p[31]
#define g_ampa_columnindex 31
#define g_nmda _p[32]
#define g_nmda_columnindex 32
#define I _p[33]
#define I_columnindex 33
#define G _p[34]
#define G_columnindex 34
#define last_dopamine _p[35]
#define last_dopamine_columnindex 35
#define weight _p[36]
#define weight_columnindex 36
#define lthresh_LTP _p[37]
#define lthresh_LTP_columnindex 37
#define lthresh_LTD _p[38]
#define lthresh_LTD_columnindex 38
#define hthresh_LTP _p[39]
#define hthresh_LTP_columnindex 39
#define A _p[40]
#define A_columnindex 40
#define B _p[41]
#define B_columnindex 41
#define C _p[42]
#define C_columnindex 42
#define D _p[43]
#define D_columnindex 43
#define factor_nmda _p[44]
#define factor_nmda_columnindex 44
#define factor_ampa _p[45]
#define factor_ampa_columnindex 45
#define block _p[46]
#define block_columnindex 46
#define ica_nmda _p[47]
#define ica_nmda_columnindex 47
#define ca_nmdai _p[48]
#define ca_nmdai_columnindex 48
#define cali _p[49]
#define cali_columnindex 49
#define DA _p[50]
#define DA_columnindex 50
#define DB _p[51]
#define DB_columnindex 51
#define DC _p[52]
#define DC_columnindex 52
#define DD _p[53]
#define DD_columnindex 53
#define _g _p[54]
#define _g_columnindex 54
#define _tsav _p[55]
#define _tsav_columnindex 55
...
#define MgBlock MgBlock_adaptive_glutamate_shom
#define hthresh hthresh_adaptive_glutamate_shom
#define lthresh lthresh_adaptive_glutamate_shom
#define min min_adaptive_glutamate_shom
#define max max_adaptive_glutamate_shom
#define reset_max reset_max_adaptive_glutamate_shom
 extern double MgBlock( );
 extern double hthresh( double , double );
 extern double lthresh( double , double );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _adaptive_glutamate_shom_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca_nmda", 2.0);
 	ion_reg("cal", 2.0);
...
#endif
  hoc_register_prop_size(_mechtype, 56, 9);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 adaptive_glutamate_shom /home/shadeform/Spillover_2/mod/adaptive_glutamate_shom.mod\n");
...
double lthresh (  double _lconc , double _lKD ) {
   double _llthresh;
 _llthresh = pow( _lconc , n ) / ( pow( _lKD , n ) + pow( _lconc , n ) ) ;
...
static double _hoc_lthresh(void* _vptr) {
 double _r;
    _hoc_setdata(_vptr);
 _r =  lthresh (  *getarg(1) , *getarg(2) );
 return(_r);
}
 
double hthresh (  double _lconc , double _lKD ) {
   double _lhthresh;
 _lhthresh = pow( _lKD , n ) / ( pow( _lKD , n ) + pow( _lconc , n ) ) ;
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   if ( stimulus_flag  == 1.0 ) {
     ...
     if ( last_dopamine  == 1.0  && active_syn_flag  == 1.0 ) {
       weight = weight + learning_rate_w_LTP * lthresh ( _threadargscomma_ ca_nmdai_max , lthresh_LTP ) * hthresh ( _threadargscomma_ ca_nmdai_max , hthresh_LTP ) ;
       lthresh_LTP = lthresh_LTP + learning_rate_thresh_LTP * lthresh ( _threadargscomma_ ca_nmdai_max , lthresh_LTP ) * ( min ( _threadargscomma_ ca_nmdai_max * delta , hthresh_LTP ) - lthresh_LTP ) ;
       lthresh_LTD = lthresh_LTD + learning_rate_thresh_LTD * lthresh ( _threadargscomma_ ca_nmdai_max , lthresh_LTP ) * ( cali_max - lthresh_LTD ) ;
       hthresh_LTP = hthresh_LTP + learning_rate_thresh_LTP * lthresh ( _threadargscomma_ ca_nmdai_max , lthresh_LTP ) * ( max ( _threadargscomma_ ca_nmdai_max * delta , lthresh_LTP ) - hthresh_LTP ) ;
       }
     else if ( last_dopamine  == - 1.0  && active_syn_flag  == 1.0 ) {
       weight = weight - learning_rate_w_LTD * lthresh ( _threadargscomma_ cali_max , lthresh_LTD ) * weight ;
       lthresh_LTP = lthresh_LTP - learning_rate_thresh_LTP * lthresh ( _threadargscomma_ cali_max , lthresh_LTD ) * ( lthresh_LTP - ca_nmdai_max ) ;
       lthresh_LTD = lthresh_LTD - learning_rate_thresh_LTD * lthresh ( _threadargscomma_ cali_max , 0.5 * lthresh_LTD ) * ( lthresh_LTD - delta * cali_max ) ;
       hthresh_LTP = hthresh_LTP - learning_rate_thresh_LTP * lthresh ( _threadargscomma_ cali_max , lthresh_LTD ) * ( min ( _threadargscomma_ hthresh_LTP + hthresh_LTP_const , hthresh_max ) ) ;
       }
     last_dopamine = dopamine ;
 ...
 v=_v;
{
  ...
  cali = _ion_cali;
 { error =  state();
 if(error){fprintf(stderr,"at line 170 in file adaptive_glutamate_shom.mod:\n	: NMDA\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_glutamate_shom.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
