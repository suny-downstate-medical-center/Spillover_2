...
#define nrn_init _nrn_init__adaptive_pf_NMDA
#define _nrn_initial _nrn_initial__adaptive_pf_NMDA
#define nrn_cur _nrn_cur__adaptive_pf_NMDA
#define _nrn_current _nrn_current__adaptive_pf_NMDA
#define nrn_jacob _nrn_jacob__adaptive_pf_NMDA
#define nrn_state _nrn_state__adaptive_pf_NMDA
#define _net_receive _net_receive__adaptive_pf_NMDA 
#define reset_max reset_max__adaptive_pf_NMDA 
#define release release__adaptive_pf_NMDA 
...
#define lthresh_LTP_min _p[12]
#define lthresh_LTP_min_columnindex 12
#define w0 _p[13]
...
#define active_syn_flag _p[16]
#define active_syn_flag_columnindex 16
#define nmda_ca_fraction _p[17]
#define nmda_ca_fraction_columnindex 17
#define Cdur _p[18]
#define Cdur_columnindex 18
#define n1 _p[19]
#define n1_columnindex 19
#define n2 _p[20]
#define n2_columnindex 20
#define KD1 _p[21]
#define KD1_columnindex 21
#define KD2 _p[22]
#define KD2_columnindex 22
#define KD_LTD _p[23]
#define KD_LTD_columnindex 23
#define n_LTD _p[24]
#define n_LTD_columnindex 24
#define iNMDA _p[25]
#define iNMDA_columnindex 25
#define g _p[26]
#define g_columnindex 26
#define last_dopamine _p[27]
#define last_dopamine_columnindex 27
#define weight _p[28]
#define weight_columnindex 28
#define lthresh_LTP _p[29]
#define lthresh_LTP_columnindex 29
#define hthresh_LTP _p[30]
#define hthresh_LTP_columnindex 30
#define Ron _p[31]
#define Ron_columnindex 31
#define Roff _p[32]
#define Roff_columnindex 32
#define Rinf _p[33]
#define Rinf_columnindex 33
#define Rtau _p[34]
#define Rtau_columnindex 34
#define synon _p[35]
#define synon_columnindex 35
#define B _p[36]
#define B_columnindex 36
#define ica_nmda _p[37]
#define ica_nmda_columnindex 37
#define cali _p[38]
#define cali_columnindex 38
#define ca_nmdai _p[39]
#define ca_nmdai_columnindex 39
#define DRon _p[40]
#define DRon_columnindex 40
#define DRoff _p[41]
#define DRoff_columnindex 41
#define _g _p[42]
...
#define _f_mgblock _f_mgblock_adaptive_pf_NMDA
#define hthresh hthresh_adaptive_pf_NMDA
#define lthresh lthresh_adaptive_pf_NMDA
#define min min_adaptive_pf_NMDA
#define max max_adaptive_pf_NMDA
#define mgblock mgblock_adaptive_pf_NMDA
#define sigmoidal sigmoidal_adaptive_pf_NMDA
...
#define usetable usetable_adaptive_pf_NMDA
 double usetable = 1;
#define wmin wmin_adaptive_pf_NMDA
 double wmin = 0.001;
#define wmax wmax_adaptive_pf_NMDA
 double wmax = 0.006;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_adaptive_pf_NMDA", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "wmax_adaptive_pf_NMDA", "uS",
 "wmin_adaptive_pf_NMDA", "uS",
 "Cmax", "mM",
 "Alpha", "/ms",
 "Beta", "/ms",
 "Erev", "mV",
 ...
 "wmax_adaptive_pf_NMDA", &wmax_adaptive_pf_NMDA,
 "wmin_adaptive_pf_NMDA", &wmin_adaptive_pf_NMDA,
 "usetable_adaptive_pf_NMDA", &usetable_adaptive_pf_NMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 44, 10);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_pf_NMDA /home/shadeform/Spillover_2/mod/adaptive_pf_NMDA.mod\n");
 ...
 B = mgblock ( _threadargscomma_ v ) ;
   ...
   if ( stimulus_flag  == 1.0 ) {
     ...
     if ( last_dopamine  == 1.0  && active_syn_flag  == 1.0 ) {
       _lkernel = sigmoidal ( _threadargscomma_ ca_nmdai_max , KD_LTD , n_LTD ) ;
       weight = weight - learning_rate_w_LTD * _lkernel * weight ;
       }
 ...
 v=_v;
{
  ...
  cali = _ion_cali;
 { error =  release();
 if(error){fprintf(stderr,"at line 151 in file adaptive_pf_NMDA.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_pf_NMDA.mod";
static const char* nmodl_file_text = 
  "\n"
  "\n"
