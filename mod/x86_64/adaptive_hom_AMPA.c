...
#define nrn_init _nrn_init__adaptive_hom_AMPA
#define _nrn_initial _nrn_initial__adaptive_hom_AMPA
#define nrn_cur _nrn_cur__adaptive_hom_AMPA
#define _nrn_current _nrn_current__adaptive_hom_AMPA
#define nrn_jacob _nrn_jacob__adaptive_hom_AMPA
#define nrn_state _nrn_state__adaptive_hom_AMPA
#define _net_receive _net_receive__adaptive_hom_AMPA 
#define reset_max reset_max__adaptive_hom_AMPA 
#define release release__adaptive_hom_AMPA 
...
#define ca_nmdai_max _p[10]
#define ca_nmdai_max_columnindex 10
#define cali_max _p[11]
#define cali_max_columnindex 11
#define active_syn_flag _p[12]
#define active_syn_flag_columnindex 12
#define thresh_LTP_max _p[13]
#define thresh_LTP_max_columnindex 13
#define thresh_LTP_0 _p[14]
#define thresh_LTP_0_columnindex 14
#define thresh_LTP_min _p[15]
#define thresh_LTP_min_columnindex 15
#define thresh_LTD_max _p[16]
#define thresh_LTD_max_columnindex 16
#define thresh_LTD_0 _p[17]
#define thresh_LTD_0_columnindex 17
#define thresh_LTD_min _p[18]
#define thresh_LTD_min_columnindex 18
#define LTD_thresh_factor _p[19]
#define LTD_thresh_factor_columnindex 19
...
#define iAMPA _p[22]
#define iAMPA_columnindex 22
#define g _p[23]
#define g_columnindex 23
#define Rinf _p[24]
#define Rinf_columnindex 24
#define Rtau _p[25]
#define Rtau_columnindex 25
#define ina _p[26]
#define ina_columnindex 26
#define last_dopamine _p[27]
#define last_dopamine_columnindex 27
#define weight _p[28]
#define weight_columnindex 28
#define thresh_LTP _p[29]
#define thresh_LTP_columnindex 29
#define thresh_LTD _p[30]
#define thresh_LTD_columnindex 30
#define Ron _p[31]
#define Ron_columnindex 31
#define Roff _p[32]
#define Roff_columnindex 32
#define synon _p[33]
#define synon_columnindex 33
#define ca_nmdai _p[34]
#define ca_nmdai_columnindex 34
#define cali _p[35]
#define cali_columnindex 35
#define DRon _p[36]
#define DRon_columnindex 36
#define DRoff _p[37]
#define DRoff_columnindex 37
#define _g _p[38]
...
#define max max_adaptive_hom_AMPA
#define pind_LTD pind_LTD_adaptive_hom_AMPA
#define pind_LTP pind_LTP_adaptive_hom_AMPA
 extern double max( double , double );
 extern double pind_LTD( double );
 extern double pind_LTP( double );
 /* declare global and static user variables */
#define Cmax Cmax_adaptive_hom_AMPA
 double Cmax = 0.1;
 ...
 "Cmax_adaptive_hom_AMPA", &Cmax_adaptive_hom_AMPA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 40, 10);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_hom_AMPA /home/shadeform/Spillover_2/mod/adaptive_hom_AMPA.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   if ( stimulus_flag  == 1.0 ) {
     ...
     if ( last_dopamine  == 1.0  && active_syn_flag  == 1.0 ) {
       ...
       thresh_LTP = thresh_LTP + learning_rate_thresh_LTP * pind_LTP ( _threadargscomma_ ca_nmdai_max ) * ( thresh_LTP_max - thresh_LTP ) ;
       thresh_LTD = thresh_LTD + learning_rate_thresh_LTD * pind_LTP ( _threadargscomma_ ca_nmdai_max ) * ( thresh_LTD_max - thresh_LTD ) ;
       }
       ...
       thresh_LTP = thresh_LTP - learning_rate_thresh_LTP * pind_LTD ( _threadargscomma_ cali_max ) * ( thresh_LTP - thresh_LTP_min ) ;
       thresh_LTD = thresh_LTD - learning_rate_thresh_LTD * pind_LTD ( _threadargscomma_ cali_max ) * ( thresh_LTD - thresh_LTD_min ) ;
       }
     last_dopamine = dopamine ;
 ...
 v=_v;
{
  ...
  ca_nmdai = _ion_ca_nmdai;
 { error =  release();
 if(error){fprintf(stderr,"at line 141 in file adaptive_hom_AMPA.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_hom_AMPA.mod";
static const char* nmodl_file_text = 
