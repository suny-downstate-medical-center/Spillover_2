...
#define drive _p[4]
#define drive_columnindex 4
#define ca_nmdai _p[5]
#define ca_nmdai_columnindex 5
#define Dca_nmdai _p[6]
#define Dca_nmdai_columnindex 6
#define ica_nmda _p[7]
#define ica_nmda_columnindex 7
#define v _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ncx /home/shadeform/Spillover_2/mod/ncx.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   Dca_nmdai = - drive * kt * ca_nmdai / ( ca_nmdai + kd ) ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
 Dca_nmdai = Dca_nmdai  / (1. - dt*( (( - drive * kt * ( ca_nmdai  + .001) / ( ( ca_nmdai  + .001) + kd ) ) - ( - drive * kt * ca_nmdai / ( ca_nmdai + kd )  )) / .001 )) ;
  return 0;
}
 /*END CVODE*/
...
static void _initlists(){
 ...
 _slist2[0] = ca_nmdai_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/ncx.mod";
static const char* nmodl_file_text = 
