...
#define nrn_init _nrn_init__adaptive_sAMPA
#define _nrn_initial _nrn_initial__adaptive_sAMPA
#define nrn_cur _nrn_cur__adaptive_sAMPA
#define _nrn_current _nrn_current__adaptive_sAMPA
#define nrn_jacob _nrn_jacob__adaptive_sAMPA
#define nrn_state _nrn_state__adaptive_sAMPA
#define _net_receive _net_receive__adaptive_sAMPA 
#define release release__adaptive_sAMPA 
...
#define Cmax Cmax_adaptive_sAMPA
 double Cmax = 0.1;
#define KD_LTD KD_LTD_adaptive_sAMPA
 double KD_LTD = 1;
#define KD2 KD2_adaptive_sAMPA
 double KD2 = 1;
#define KD1 KD1_adaptive_sAMPA
 double KD1 = 1;
#define learning_rate_w_LTD learning_rate_w_LTD_adaptive_sAMPA
 double learning_rate_w_LTD = 0.01;
#define learning_rate_w_LTP learning_rate_w_LTP_adaptive_sAMPA
 double learning_rate_w_LTP = 0.01;
#define n_LTD n_LTD_adaptive_sAMPA
 double n_LTD = 1;
#define n2 n2_adaptive_sAMPA
 double n2 = 5;
#define n1 n1_adaptive_sAMPA
 double n1 = 5;
#define w0 w0_adaptive_sAMPA
 double w0 = 0.00188;
 ...
 "Cmax_adaptive_sAMPA", "mM",
 "w0_adaptive_sAMPA", "uS",
 "Cdur", "ms",
 "Alpha", "/ms",
 "Beta", "/ms",
 "Erev", "mV",
 ...
 "Cmax_adaptive_sAMPA", &Cmax_adaptive_sAMPA,
 "learning_rate_w_LTP_adaptive_sAMPA", &learning_rate_w_LTP_adaptive_sAMPA,
 "learning_rate_w_LTD_adaptive_sAMPA", &learning_rate_w_LTD_adaptive_sAMPA,
 "w0_adaptive_sAMPA", &w0_adaptive_sAMPA,
 "n1_adaptive_sAMPA", &n1_adaptive_sAMPA,
 "n2_adaptive_sAMPA", &n2_adaptive_sAMPA,
 "KD1_adaptive_sAMPA", &KD1_adaptive_sAMPA,
 "KD2_adaptive_sAMPA", &KD2_adaptive_sAMPA,
 "KD_LTD_adaptive_sAMPA", &KD_LTD_adaptive_sAMPA,
 "n_LTD_adaptive_sAMPA", &n_LTD_adaptive_sAMPA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_sAMPA /home/shadeform/Spillover_2/mod/adaptive_sAMPA.mod\n");
 ...
 v=_v;
{
  ...
  ca_nmdai = _ion_ca_nmdai;
 { error =  release();
 if(error){fprintf(stderr,"at line 118 in file adaptive_sAMPA.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_sAMPA.mod";
static const char* nmodl_file_text = 
