...
#define nrn_init _nrn_init__adaptive_glutamate
#define _nrn_initial _nrn_initial__adaptive_glutamate
#define nrn_cur _nrn_cur__adaptive_glutamate
#define _nrn_current _nrn_current__adaptive_glutamate
#define nrn_jacob _nrn_jacob__adaptive_glutamate
#define nrn_state _nrn_state__adaptive_glutamate
#define _net_receive _net_receive__adaptive_glutamate 
#define state state__adaptive_glutamate 
...
#define wmax _p[12]
#define wmax_columnindex 12
#define wmin _p[13]
#define wmin_columnindex 13
#define learning_rate_w_LTP _p[14]
#define learning_rate_w_LTP_columnindex 14
#define learning_rate_w_LTD _p[15]
#define learning_rate_w_LTD_columnindex 15
#define thresh_LTP _p[16]
#define thresh_LTP_columnindex 16
#define thresh_LTD _p[17]
#define thresh_LTD_columnindex 17
#define nmda_ca_fraction _p[18]
#define nmda_ca_fraction_columnindex 18
#define ca_nmdai_max _p[19]
#define ca_nmdai_max_columnindex 19
#define cali_max _p[20]
#define cali_max_columnindex 20
#define active_syn_flag _p[21]
#define active_syn_flag_columnindex 21
#define i _p[22]
#define i_columnindex 22
#define g _p[23]
#define g_columnindex 23
#define i_ampa _p[24]
#define i_ampa_columnindex 24
#define i_nmda _p[25]
#define i_nmda_columnindex 25
#define g_ampa _p[26]
#define g_ampa_columnindex 26
#define g_nmda _p[27]
#define g_nmda_columnindex 27
#define I _p[28]
...
#define block _p[38]
#define block_columnindex 38
#define ica_nmda _p[39]
#define ica_nmda_columnindex 39
#define ca_nmdai _p[40]
#define ca_nmdai_columnindex 40
#define cali _p[41]
#define cali_columnindex 41
#define DA _p[42]
#define DA_columnindex 42
#define DB _p[43]
#define DB_columnindex 43
#define DC _p[44]
#define DC_columnindex 44
#define DD _p[45]
#define DD_columnindex 45
#define _g _p[46]
...
#define MgBlock MgBlock_adaptive_glutamate
#define min min_adaptive_glutamate
#define max max_adaptive_glutamate
#define pind_LTD pind_LTD_adaptive_glutamate
#define pind_LTP pind_LTP_adaptive_glutamate
#define reset_max reset_max_adaptive_glutamate
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 48, 9);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 adaptive_glutamate /home/shadeform/Spillover_2/mod/adaptive_glutamate.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   if ( stimulus_flag  == 1.0 ) {
     ...
     if ( last_dopamine  == 1.0  && active_syn_flag  == 1.0 ) {
       weight = weight + learning_rate_w_LTP * pind_LTP ( _threadargscomma_ ca_nmdai ) * ( wmax - weight ) ;
       }
     else if ( last_dopamine  == - 1.0  && active_syn_flag  == 1.0 ) {
       weight = weight - learning_rate_w_LTD * pind_LTD ( _threadargscomma_ cali ) * ( weight - wmin ) ;
       }
     last_dopamine = dopamine ;
 ...
 v=_v;
{
  ...
  cali = _ion_cali;
 { error =  state();
 if(error){fprintf(stderr,"at line 155 in file adaptive_glutamate.mod:\n	: NMDA\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_glutamate.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
