...
#define nrn_init _nrn_init__adaptive_my_shom_NMDA
#define _nrn_initial _nrn_initial__adaptive_my_shom_NMDA
#define nrn_cur _nrn_cur__adaptive_my_shom_NMDA
#define _nrn_current _nrn_current__adaptive_my_shom_NMDA
#define nrn_jacob _nrn_jacob__adaptive_my_shom_NMDA
#define nrn_state _nrn_state__adaptive_my_shom_NMDA
#define _net_receive _net_receive__adaptive_my_shom_NMDA 
#define reset_max reset_max__adaptive_my_shom_NMDA 
#define release release__adaptive_my_shom_NMDA 
...
#define cai_max _p[14]
#define cai_max_columnindex 14
#define ca_nmdai_max _p[15]
#define ca_nmdai_max_columnindex 15
#define cali_max _p[16]
#define cali_max_columnindex 16
#define cati_max _p[17]
#define cati_max_columnindex 17
#define calcium _p[18]
#define calcium_columnindex 18
#define active_syn_flag _p[19]
#define active_syn_flag_columnindex 19
#define nmda_ca_fraction _p[20]
#define nmda_ca_fraction_columnindex 20
#define Cdur _p[21]
#define Cdur_columnindex 21
#define n1 _p[22]
#define n1_columnindex 22
#define n2 _p[23]
#define n2_columnindex 23
#define KD1 _p[24]
#define KD1_columnindex 24
#define KD2 _p[25]
#define KD2_columnindex 25
#define KD_LTD _p[26]
#define KD_LTD_columnindex 26
#define n_LTD _p[27]
#define n_LTD_columnindex 27
#define iNMDA _p[28]
...
#define kernel_LTD _p[36]
#define kernel_LTD_columnindex 36
#define Ron _p[37]
#define Ron_columnindex 37
#define Roff _p[38]
#define Roff_columnindex 38
#define Rinf _p[39]
#define Rinf_columnindex 39
#define Rtau _p[40]
#define Rtau_columnindex 40
#define synon _p[41]
#define synon_columnindex 41
#define B _p[42]
#define B_columnindex 42
#define ica _p[43]
#define ica_columnindex 43
#define cai _p[44]
#define cai_columnindex 44
#define cati _p[45]
#define cati_columnindex 45
#define cali _p[46]
#define cali_columnindex 46
#define ca_nmdai _p[47]
#define ca_nmdai_columnindex 47
#define DRon _p[48]
#define DRon_columnindex 48
#define DRoff _p[49]
#define DRoff_columnindex 49
#define _g _p[50]
#define _g_columnindex 50
#define _tsav _p[51]
#define _tsav_columnindex 51
...
#define _f_mgblock _f_mgblock_adaptive_my_shom_NMDA
#define hthresh hthresh_adaptive_my_shom_NMDA
#define lthresh lthresh_adaptive_my_shom_NMDA
#define min min_adaptive_my_shom_NMDA
#define max max_adaptive_my_shom_NMDA
#define mgblock mgblock_adaptive_my_shom_NMDA
#define quadratic quadratic_adaptive_my_shom_NMDA
#define sigmoidal sigmoidal_adaptive_my_shom_NMDA
...
#define usetable usetable_adaptive_my_shom_NMDA
 double usetable = 1;
#define wmin wmin_adaptive_my_shom_NMDA
 double wmin = 0.001;
#define wmax wmax_adaptive_my_shom_NMDA
 double wmax = 0.006;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_adaptive_my_shom_NMDA", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "wmax_adaptive_my_shom_NMDA", "uS",
 "wmin_adaptive_my_shom_NMDA", "uS",
 "Cmax", "mM",
 "Alpha", "/ms",
 "Beta", "/ms",
 "Erev", "mV",
 ...
 "wmax_adaptive_my_shom_NMDA", &wmax_adaptive_my_shom_NMDA,
 "wmin_adaptive_my_shom_NMDA", &wmin_adaptive_my_shom_NMDA,
 "usetable_adaptive_my_shom_NMDA", &usetable_adaptive_my_shom_NMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _adaptive_my_shom_NMDA_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca_nmda", 2.0);
 	ion_reg("cal", 2.0);
...
#endif
  hoc_register_prop_size(_mechtype, 52, 12);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_my_shom_NMDA /home/shadeform/Spillover_2/mod/adaptive_my_shom_NMDA.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   double _lnorm , _lnorm_LTD , _lnormt , _lkernelt ;
 B = mgblock ( _threadargscomma_ v ) ;
   ...
   if ( stimulus_flag  == 1.0 ) {
     ...
     cai_max = max ( _threadargscomma_ cai , cai_max ) ;
     ...
     if ( last_dopamine  == 1.0  && active_syn_flag  == 1.0 ) {
       ...
       kernel = sigmoidal ( _threadargscomma_ calcium , lthresh_LTP , n1 ) * ( 1.0 - sigmoidal ( _threadargscomma_ calcium , hthresh_LTP , n2 ) ) * 1.0 / _lnorm ;
       _lnormt = sigmoidal ( _threadargscomma_ 0.5 * ( lthresh_LTP + hthresh_LTP ) , lthresh_LTP , n1 * 0.3 ) * ( 1.0 - sigmoidal ( _threadargscomma_ 0.5 * ( lthresh_LTP + hthresh_LTP ) , hthresh_LTP , n2 * 0.3 ) ) ;
       _lkernelt = sigmoidal ( _threadargscomma_ calcium , lthresh_LTP , n1 * 0.3 ) * ( 1.0 - sigmoidal ( _threadargscomma_ calcium , hthresh_LTP , n2 * 0.3 ) ) * 1.0 / _lnorm ;
       if ( kernel < 0.01 ) {
         kernel = 0.0 ;
         }
       if ( _lkernelt < 0.01 ) {
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  release();
 if(error){fprintf(stderr,"at line 161 in file adaptive_my_shom_NMDA.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_my_shom_NMDA.mod";
static const char* nmodl_file_text = 
  "\n"
  "\n"
