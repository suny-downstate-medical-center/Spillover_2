...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal12 /home/shadeform/Spillover_2/mod/cal12.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pbar * m * ( h * a + 1.0 - a ) * ghk ( _threadargscomma_ v , cai , cao ) ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/cal12.mod";
static const char* nmodl_file_text = 
  ...
  "    ica = pbar*m*(h*a+1-a)*ghk(v, cai, cao)\n"
  "}\n"
  "\n"
  "INITIAL {\n"
  "    rates()\n"
