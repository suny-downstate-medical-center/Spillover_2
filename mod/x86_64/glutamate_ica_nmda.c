...
#define eta _p[8]
#define eta_columnindex 8
#define q _p[9]
#define q_columnindex 9
#define w_ampa _p[10]
#define w_ampa_columnindex 10
#define w_nmda _p[11]
#define w_nmda_columnindex 11
#define nmda_ca_fraction _p[12]
#define nmda_ca_fraction_columnindex 12
#define i _p[13]
...
#define A _p[21]
#define A_columnindex 21
#define B _p[22]
#define B_columnindex 22
#define C _p[23]
#define C_columnindex 23
#define D _p[24]
#define D_columnindex 24
#define factor_nmda _p[25]
#define factor_nmda_columnindex 25
#define factor_ampa _p[26]
#define factor_ampa_columnindex 26
#define block _p[27]
#define block_columnindex 27
#define ica_nmda _p[28]
#define ica_nmda_columnindex 28
#define DA _p[29]
...
#define DD _p[32]
#define DD_columnindex 32
#define v _p[33]
#define v_columnindex 33
#define _g _p[34]
#define _g_columnindex 34
#define _tsav _p[35]
#define _tsav_columnindex 35
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 glutamate_ica_nmda /home/shadeform/Spillover_2/mod/glutamate_ica_nmda.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ...
   G = g_ampa + g_nmda ;
   I = i_ampa + ( 1.0 - nmda_ca_fraction ) * i_nmda ;
   i = I ;
   }
 _current += i;
 _current += ica_nmda;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/glutamate_ica_nmda.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  ...
  "	\n"
  "	RANGE i_ampa, i_nmda, g_ampa, g_nmda, w_ampa, w_nmda, I, G, mg, q, alpha, eta, nmda_ca_fraction\n"
  ...
  "	: total current\n"
  "	G = g_ampa + g_nmda\n"
  "	I = i_ampa + (1- nmda_ca_fraction)*i_nmda\n"
  "    	i = I\n"
  "}\n"
  "\n"
  "\n"
