...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 adaptive_glutamate_test /mnt/data/Spillover_2/mod/adaptive_glutamate_test.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/data/Spillover_2/mod/adaptive_glutamate_test.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
