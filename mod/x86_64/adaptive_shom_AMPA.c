...
#define nrn_init _nrn_init__adaptive_shom_AMPA
#define _nrn_initial _nrn_initial__adaptive_shom_AMPA
#define nrn_cur _nrn_cur__adaptive_shom_AMPA
#define _nrn_current _nrn_current__adaptive_shom_AMPA
#define nrn_jacob _nrn_jacob__adaptive_shom_AMPA
#define nrn_state _nrn_state__adaptive_shom_AMPA
#define _net_receive _net_receive__adaptive_shom_AMPA 
#define release release__adaptive_shom_AMPA 
...
#define Cmax Cmax_adaptive_shom_AMPA
 double Cmax = 0.1;
#define KD_LTD KD_LTD_adaptive_shom_AMPA
 double KD_LTD = 1;
#define KD2 KD2_adaptive_shom_AMPA
 double KD2 = 1;
#define KD1 KD1_adaptive_shom_AMPA
 double KD1 = 1;
#define learning_rate_w_LTD learning_rate_w_LTD_adaptive_shom_AMPA
 double learning_rate_w_LTD = 0.01;
#define learning_rate_w_LTP learning_rate_w_LTP_adaptive_shom_AMPA
 double learning_rate_w_LTP = 0.01;
#define n_LTD n_LTD_adaptive_shom_AMPA
 double n_LTD = 1;
#define n2 n2_adaptive_shom_AMPA
 double n2 = 5;
#define n1 n1_adaptive_shom_AMPA
 double n1 = 5;
 ...
 "Cmax_adaptive_shom_AMPA", &Cmax_adaptive_shom_AMPA,
 "learning_rate_w_LTP_adaptive_shom_AMPA", &learning_rate_w_LTP_adaptive_shom_AMPA,
 "learning_rate_w_LTD_adaptive_shom_AMPA", &learning_rate_w_LTD_adaptive_shom_AMPA,
 "n1_adaptive_shom_AMPA", &n1_adaptive_shom_AMPA,
 "n2_adaptive_shom_AMPA", &n2_adaptive_shom_AMPA,
 "KD1_adaptive_shom_AMPA", &KD1_adaptive_shom_AMPA,
 "KD2_adaptive_shom_AMPA", &KD2_adaptive_shom_AMPA,
 "KD_LTD_adaptive_shom_AMPA", &KD_LTD_adaptive_shom_AMPA,
 "n_LTD_adaptive_shom_AMPA", &n_LTD_adaptive_shom_AMPA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_shom_AMPA /home/shadeform/Spillover_2/mod/adaptive_shom_AMPA.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 112 in file adaptive_shom_AMPA.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_shom_AMPA.mod";
static const char* nmodl_file_text = 
