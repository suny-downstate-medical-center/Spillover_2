...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_shom_AMPA /www/projects/Spillover/mod/adaptive_shom_AMPA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/www/projects/Spillover/mod/adaptive_shom_AMPA.mod";
static const char* nmodl_file_text = 
