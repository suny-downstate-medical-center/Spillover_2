...
import d1msn as msn
#import iMSN
import spillover_experiment_2 as pe
import pickle
...
cell = msn.MSN(variables = variables, morphology=) 
...
print (" plateau_cluster_list ", plateau_cluster_list) 
print (" p.cluster_start_pos ", p.cluster_start_pos) 
print (" p.cluster_end_pos ", p.cluster_end_pos) 
