...
#define nrn_init _nrn_init__adaptive_sNMDA
#define _nrn_initial _nrn_initial__adaptive_sNMDA
#define nrn_cur _nrn_cur__adaptive_sNMDA
#define _nrn_current _nrn_current__adaptive_sNMDA
#define nrn_jacob _nrn_jacob__adaptive_sNMDA
#define nrn_state _nrn_state__adaptive_sNMDA
#define _net_receive _net_receive__adaptive_sNMDA 
#define reset_max reset_max__adaptive_sNMDA 
#define release release__adaptive_sNMDA 
...
#define wmax _p[10]
#define wmax_columnindex 10
#define wmin _p[11]
#define wmin_columnindex 11
#define w0 _p[12]
...
#define nmda_ca_fraction _p[16]
#define nmda_ca_fraction_columnindex 16
#define Cdur _p[17]
#define Cdur_columnindex 17
#define n1 _p[18]
...
#define iNMDA _p[24]
#define iNMDA_columnindex 24
#define g _p[25]
#define g_columnindex 25
#define last_dopamine _p[26]
#define last_dopamine_columnindex 26
#define weight _p[27]
#define weight_columnindex 27
#define lthresh_LTP _p[28]
#define lthresh_LTP_columnindex 28
#define hthresh_LTP _p[29]
#define hthresh_LTP_columnindex 29
#define Ron _p[30]
#define Ron_columnindex 30
#define Roff _p[31]
#define Roff_columnindex 31
#define Rinf _p[32]
#define Rinf_columnindex 32
#define Rtau _p[33]
#define Rtau_columnindex 33
#define synon _p[34]
#define synon_columnindex 34
#define B _p[35]
#define B_columnindex 35
#define ica_nmda _p[36]
#define ica_nmda_columnindex 36
#define cali _p[37]
#define cali_columnindex 37
#define ca_nmdai _p[38]
#define ca_nmdai_columnindex 38
#define DRon _p[39]
#define DRon_columnindex 39
#define DRoff _p[40]
#define DRoff_columnindex 40
#define _g _p[41]
...
#define _f_mgblock _f_mgblock_adaptive_sNMDA
#define hthresh hthresh_adaptive_sNMDA
#define lthresh lthresh_adaptive_sNMDA
#define max max_adaptive_sNMDA
#define mgblock mgblock_adaptive_sNMDA
#define sigmoidal sigmoidal_adaptive_sNMDA
...
#define usetable usetable_adaptive_sNMDA
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_adaptive_sNMDA", 0, 1,
 0,0,0
};
 ...
 "usetable_adaptive_sNMDA", &usetable_adaptive_sNMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 43, 10);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_sNMDA /home/shadeform/Spillover_2/mod/adaptive_sNMDA.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   if ( stimulus_flag  == 1.0 ) {
     ...
     if ( last_dopamine  == 1.0  && active_syn_flag  == 1.0 ) {
       lthresh_LTP = sigmoidal ( _threadargscomma_ ca_nmdai_max , KD1 , n1 ) ;
       hthresh_LTP = 1.0 - sigmoidal ( _threadargscomma_ ca_nmdai_max , KD2 , n2 ) ;
 ...
 v=_v;
{
  ...
  cali = _ion_cali;
 { error =  release();
 if(error){fprintf(stderr,"at line 147 in file adaptive_sNMDA.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_sNMDA.mod";
static const char* nmodl_file_text = 
  "\n"
  "\n"
