...
#define ca_nmdai _p[3]
#define ca_nmdai_columnindex 3
#define ek _p[4]
...
#define _ion_ca_nmdai	*_ppvar[0]._pval
...
static void nrn_alloc(Prop* _prop) {
 ...
 nrn_promote(prop_ion, 1, 0);
 	_ppvar[0]._pval = &prop_ion->param[1]; /* ca_nmdai */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 sk /www/projects/Spillover/mod/sk.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   rate ( _threadargscomma_ v , ca_nmdai ) ;
   Do = ( oinf - o ) / otau * q ;
   }
 return _reset;
}
...
static void _ode_matsol(NrnThread* _nt, _Memb_list* _ml, int _type) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   nrn_update_ion_pointer(_ca_nmda_sym, _ppvar, 0, 1);
...
#if NMODL_TEXT
static const char* nmodl_filename = "/www/projects/Spillover/mod/sk.mod";
static const char* nmodl_file_text = 
