...
#define nrn_init _nrn_init__adaptive_sglutamate
#define _nrn_initial _nrn_initial__adaptive_sglutamate
#define nrn_cur _nrn_cur__adaptive_sglutamate
#define _nrn_current _nrn_current__adaptive_sglutamate
#define nrn_jacob _nrn_jacob__adaptive_sglutamate
#define nrn_state _nrn_state__adaptive_sglutamate
#define _net_receive _net_receive__adaptive_sglutamate 
#define state state__adaptive_sglutamate 
...
#define delta _p[14]
#define delta_columnindex 14
#define hthresh_LTP_const _p[15]
#define hthresh_LTP_const_columnindex 15
#define learning_rate_thresh_LTP _p[16]
#define learning_rate_thresh_LTP_columnindex 16
#define learning_rate_thresh_LTD _p[17]
#define learning_rate_thresh_LTD_columnindex 17
#define n1 _p[18]
#define n1_columnindex 18
#define n2 _p[19]
#define n2_columnindex 19
#define KD1 _p[20]
#define KD1_columnindex 20
#define KD2 _p[21]
#define KD2_columnindex 21
#define KD_LTD _p[22]
#define KD_LTD_columnindex 22
#define n_LTD _p[23]
#define n_LTD_columnindex 23
#define nmda_ca_fraction _p[24]
#define nmda_ca_fraction_columnindex 24
#define ca_nmdai_max _p[25]
#define ca_nmdai_max_columnindex 25
#define cali_max _p[26]
#define cali_max_columnindex 26
#define active_syn_flag _p[27]
#define active_syn_flag_columnindex 27
#define i _p[28]
#define i_columnindex 28
#define g _p[29]
#define g_columnindex 29
#define i_ampa _p[30]
#define i_ampa_columnindex 30
#define i_nmda _p[31]
#define i_nmda_columnindex 31
#define g_ampa _p[32]
#define g_ampa_columnindex 32
#define g_nmda _p[33]
#define g_nmda_columnindex 33
#define I _p[34]
#define I_columnindex 34
#define G _p[35]
#define G_columnindex 35
#define last_dopamine _p[36]
#define last_dopamine_columnindex 36
#define weight _p[37]
#define weight_columnindex 37
#define lthresh_LTP _p[38]
#define lthresh_LTP_columnindex 38
#define lthresh_LTD _p[39]
#define lthresh_LTD_columnindex 39
#define hthresh_LTP _p[40]
#define hthresh_LTP_columnindex 40
#define A _p[41]
...
#define MgBlock MgBlock_adaptive_sglutamate
#define hthresh hthresh_adaptive_sglutamate
#define lthresh lthresh_adaptive_sglutamate
#define min min_adaptive_sglutamate
#define max max_adaptive_sglutamate
#define reset_max reset_max_adaptive_sglutamate
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 adaptive_sglutamate /home/shadeform/Spillover_2/mod/adaptive_sglutamate.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   if ( stimulus_flag  == 1.0 ) {
     ...
     if ( last_dopamine  == 1.0  && active_syn_flag  == 1.0 ) {
       weight = weight + learning_rate_w_LTP * lthresh ( _threadargscomma_ ca_nmdai_max , KD1 , n1 ) * hthresh ( _threadargscomma_ ca_nmdai_max , KD2 , n2 ) ;
       lthresh_LTP = lthresh ( _threadargscomma_ ca_nmdai_max , KD1 , n1 ) ;
       hthresh_LTP = hthresh ( _threadargscomma_ ca_nmdai_max , KD2 , n2 ) ;
       }
     else if ( last_dopamine  == - 1.0  && active_syn_flag  == 1.0 ) {
       weight = weight - learning_rate_w_LTD * lthresh ( _threadargscomma_ cali_max , KD_LTD , n_LTD ) * weight ;
       lthresh_LTD = lthresh ( _threadargscomma_ cali_max , KD_LTD , n_LTD ) ;
       }
     last_dopamine = dopamine ;
 ...
 v=_v;
{
  ...
  cali = _ion_cali;
 { error =  state();
 if(error){fprintf(stderr,"at line 170 in file adaptive_sglutamate.mod:\n	: NMDA\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_sglutamate.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
