...
def run_sim(cell_type,cell_ID, morphology, folder_number):
    try:
...
for dir_name in os.listdir('morphology/msn_morphologies'):
    ...
    for cell_type in os.listdir('morphology/msn_morphologies/' + dir_name):
        for cell_ID in range (1,34):
            # print ( " in second for ")
            # print ('morphology/msn_morphologies/' + dir_name + '/' + cell_type)
            if os.path.isdir('morphology/msn_morphologies/' + dir_name + '/' + cell_type):
                # print ('------------ morphology/msn_morphologies/' + dir_name + '/' + cell_type)
                for morphology_file in os.listdir('morphology/msn_morphologies/' + dir_name + '/' + cell_type):
                    morphology = 'morphology/msn_morphologies/' + dir_name + '/' + cell_type + '/' + morphology_file
                    print ( " running for cell type ", cell_type, " id ", cell_ID, " morphology ", morphology , " folder ", folder_number )
                    run_sim(cell_type,cell_ID, morphology, folder_number)
                    found = True
                    print ( " breaking 0000 ")
                    break
            else:
