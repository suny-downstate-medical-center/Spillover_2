...
for cell_id in cell_ids:
    ...
    try:
        ...
        plt.savefig("d1_results_" + str(cell_id) + ".png")
    except:
        traceback.print_exc(file=sys.stdout)

# def plotCell():
#     try:
#         # create a space for a parameter
...
#           if node.segment in selectedSegs:

#               node.value = 500

#           elif node.segment in allSegmentsList:

#               node.value = 230

#         cell = {}
#         cell["dendriteLocPlotURL"] = ""
#         try:
...
#             my_plot = ps.plot(plotly)
#             my_plot.write_html('mechfigs/dendriteLocPlotURL.html')
#             cell["dendriteLocPlotURL"] = '/mechfigs/dendriteLocPlotURL.html'
#         except:
#             pass
#     pass
