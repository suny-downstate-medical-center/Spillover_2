...
#define nrn_init _nrn_init__adaptive_pf_AMPA
#define _nrn_initial _nrn_initial__adaptive_pf_AMPA
#define nrn_cur _nrn_cur__adaptive_pf_AMPA
#define _nrn_current _nrn_current__adaptive_pf_AMPA
#define nrn_jacob _nrn_jacob__adaptive_pf_AMPA
#define nrn_state _nrn_state__adaptive_pf_AMPA
#define _net_receive _net_receive__adaptive_pf_AMPA 
#define release release__adaptive_pf_AMPA 
...
#define ca_nmdai _p[13]
#define ca_nmdai_columnindex 13
#define cali _p[14]
#define cali_columnindex 14
#define DRon _p[15]
#define DRon_columnindex 15
#define DRoff _p[16]
#define DRoff_columnindex 16
#define _g _p[17]
...
#define Cmax Cmax_adaptive_pf_AMPA
 double Cmax = 0.1;
#define KD_LTD KD_LTD_adaptive_pf_AMPA
 double KD_LTD = 1;
#define KD2 KD2_adaptive_pf_AMPA
 double KD2 = 1;
#define KD1 KD1_adaptive_pf_AMPA
 double KD1 = 1;
#define learning_rate_w_LTD learning_rate_w_LTD_adaptive_pf_AMPA
 double learning_rate_w_LTD = 0.01;
#define learning_rate_w_LTP learning_rate_w_LTP_adaptive_pf_AMPA
 double learning_rate_w_LTP = 0.01;
#define n_LTD n_LTD_adaptive_pf_AMPA
 double n_LTD = 1;
#define n2 n2_adaptive_pf_AMPA
 double n2 = 5;
#define n1 n1_adaptive_pf_AMPA
 double n1 = 5;
#define w0 w0_adaptive_pf_AMPA
 double w0 = 0.00188;
 ...
 "Cmax_adaptive_pf_AMPA", "mM",
 "w0_adaptive_pf_AMPA", "uS",
 "Cdur", "ms",
 "Alpha", "/ms",
 "Beta", "/ms",
 "Erev", "mV",
 ...
 "Cmax_adaptive_pf_AMPA", &Cmax_adaptive_pf_AMPA,
 "learning_rate_w_LTP_adaptive_pf_AMPA", &learning_rate_w_LTP_adaptive_pf_AMPA,
 "learning_rate_w_LTD_adaptive_pf_AMPA", &learning_rate_w_LTD_adaptive_pf_AMPA,
 "w0_adaptive_pf_AMPA", &w0_adaptive_pf_AMPA,
 "n1_adaptive_pf_AMPA", &n1_adaptive_pf_AMPA,
 "n2_adaptive_pf_AMPA", &n2_adaptive_pf_AMPA,
 "KD1_adaptive_pf_AMPA", &KD1_adaptive_pf_AMPA,
 "KD2_adaptive_pf_AMPA", &KD2_adaptive_pf_AMPA,
 "KD_LTD_adaptive_pf_AMPA", &KD_LTD_adaptive_pf_AMPA,
 "n_LTD_adaptive_pf_AMPA", &n_LTD_adaptive_pf_AMPA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 19, 9);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 adaptive_pf_AMPA /home/shadeform/Spillover_2/mod/adaptive_pf_AMPA.mod\n");
 ...
 v=_v;
{
  ...
  ca_nmdai = _ion_ca_nmdai;
 { error =  release();
 if(error){fprintf(stderr,"at line 118 in file adaptive_pf_AMPA.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shadeform/Spillover_2/mod/adaptive_pf_AMPA.mod";
static const char* nmodl_file_text = 
  ...
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS adaptive_pf_AMPA\n"
